...
export class TeamMatchController {
  ...
  async find(
    ...
    return this.teamRepository.awayMatches(id).find(filter);
  }
  ...
  async create(
    ...
    return this.teamRepository.awayMatches(id).create(match);
  }
  ...
  async patch(
    ...
    return this.teamRepository.awayMatches(id).patch(match, where);
  }
  ...
  async delete(
    ...
    return this.teamRepository.awayMatches(id).delete(where);
  }
}
